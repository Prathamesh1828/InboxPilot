...
async def telegram_webhook(
    ...
    try:
        if action == "approve":
            ApprovalService.approve(db=db, approval_id=approval_id, user_id=connection.user_id)
            ...
            ApprovalService.reject(db=db, approval_id=approval_id, user_id=connection.user_id)
